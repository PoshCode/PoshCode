...
FunctionsToExport = 'Invoke-Web', 'Get-ModulePackage', 'Install-ModulePackage', 
    'New-ModulePackage', 'Get-ModuleInfo', 'Update-ModuleInfo', 
    'Get-SpecialFolder', 'Test-ConfigData', 'Get-ConfigData', 'Set-ConfigData'
